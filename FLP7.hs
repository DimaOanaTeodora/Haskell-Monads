...
-- Memoria formata din 2 liste asociative
-- env: "n"(Id din Exp) 1 (variabila locatie)
-- store: 1 (Val 2) (locatie valoare)
data ImpState = ImpState
    { env :: Map String Int -- variabile - locatiile de memorie
    , store :: Map Int Value -- asocierea intre locatie si valoare
    , nextLoc :: Int
    }
  deriving (Show)
